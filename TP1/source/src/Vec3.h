...
public:
    ...
    static Vec3 cross(Vec3 const &a, Vec3 const &b) {
        //TODO: Fonction à compléter
        Vec3 res = Vec3(a[1]*b[2]-a[2]*b[1], a[2]*b[0]-a[0]*b[2], a[0]*b[1]-a[1]*b[0]); //Faire le calcul ici et assigner le resultat à res
        return res;
    }
...
public:
    ...
    Vec3 operator*(const Vec3 &p) {
        ...
        Vec3 res = c; //Faire le calcul ici et assigner le resultat à res
        return res;
    }
